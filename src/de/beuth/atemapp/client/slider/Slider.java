 ...
 *
 ******************************************************************************/
package de.beuth.atemapp.client.slider;
...
public class Slider extends Widget {
	...
	/**
	 * Create a slider with the specified ID. The ID is required because the
	 * slider needs a specific ID to connect to.
	 * 
	 * @param id
	 *           - id of the element
	 * @param min
	 *           - default minimum of the slider
	 * @param max
	 *           - default maximum of the slider
	 * @param defaultValue
	 *           - default point of a single anchor
	 */
	 ...
	 *           - id of the element to create
	 * @param options
	 *           - JSONObject of any possible option, can be null for defaults
	 */
	...
	/**
	 * A convenient way to create an options JSONObject. Use SliderOption for
	 * keys.
	 * 
	 * @param min
	 *           - default minimum of the slider
	...
	protected void onLoad() {
		createSliderJS(this, getElement().getId(),
				m_defaultOptions.getJavaScriptObject());
		super.onLoad();
	}
	...
	public String getStringOption(SliderOption option) {
		// getStringOptionJS(getElement().getId(), new JS)
		JavaScriptObject obj = getStringOptionJS(getElement().getId(),
				option.toString());
		return obj.toString();
	}

	public void enable() {
		enableJS(getElement().getId());
	}
	 ...
	 * JSNI methods
	 */
	private native void enableJS(String id) /*-{
	...
	private native void setBooleanOptionJS(String id, String option,
			boolean value) /*-{
		$wnd.$("#" + id).slider("option", option, value);
	}-*/;
	...
	private native JavaScriptObject getStringOptionJS(String id, String option) /*-{
		return $wnd.$("#" + id).slider("option", option);
	}-*/;
	...
	private native void createSliderJS(Slider x, String id,
			JavaScriptObject options) /*-{
		options.start = function(event, ui) {
			x.@de.beuth.atemapp.client.slider.Slider::fireOnStartEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
		};
		options.slide = function(event, ui) {
			return x.@de.beuth.atemapp.client.slider.Slider::fireOnSlideEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
		};
		options.change = function(event, ui) {
			var has = event.originalEvent ? true : false;
			x.@de.beuth.atemapp.client.slider.Slider::fireOnChangeEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;Z)(event, ui.values, has);
		};
		options.stop = function(event, ui) {
			x.@de.beuth.atemapp.client.slider.Slider::fireOnStopEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
		};
