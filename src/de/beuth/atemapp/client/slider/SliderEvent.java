...
public class SliderEvent {
	 ...
	 * 
	 * @param event
	 *           - the event received by JSNI called
	 * @param source
	 *           - the Slider that fires the event
	 * @param values
	 *           - int array of values
	 */
	 ...
	 * @param values
	 *           - int array of values
	 * @param hasOriginalEvent
	 *           - boolean if the change came from a non-programmatic change such
	 *           as mouse or keyboard event
	 */
	public SliderEvent(Event event, Slider source, int[] values,
